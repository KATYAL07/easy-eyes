  ...
  return (
    <>
      ...
      <div className="flex justify-center py-12 bg-surface fade-in-section">
        <Link className="inline-flex items-center justify-center px-10 py-4 border border-primary text-primary font-label-caps text-label-caps rounded uppercase tracking-widest hover:bg-primary hover:text-on-primary transition-all duration-300" to="/shop">
          Shop the Collection
        </Link>
      </div>
        ...
        <section className="py-section-gap px-margin-mobile md:px-margin-desktop fade-in-section">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-gutter">
            <Link className="group md:col-span-7 h-[600px] relative overflow-hidden flex items-end p-12 bg-surface-container" to="/shop">
              <img alt="A close-up fashion portrait focusing on the elegant structure of a woman's face and the perfect geometric fit of her oversized sunglasses. Studio lighting with warm, subtle beige undertones highlights the premium acetate frames against a minimalist, soft cream background, exuding quiet luxury." className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" data-alt="A close-up fashion portrait focusing on the elegant structure of a woman's face and the perfect geometric fit of her oversized sunglasses. Studio lighting with warm, subtle beige undertones highlights the premium acetate frames against a minimalist, soft cream background, exuding quiet luxury." src="https://lh3.googleusercontent.com/aida-public/AB6AXuASsGokQm9f9hnlQW-byviux2JZWjUBPUA5jGjQghzmJTehk0mXW8O3wHtB-yImPjYw9P7zloU8EI5a9PxxzzqVTLUfCHvnvYW-1PAslIYVU-LA6asv2c93713Oyq8pPgTnSSF4ck8I-5ojhAAEpqlnkoW2z3EFTv1zj4rb48usNtUkiMgEc7UWGDVxjcQn7xsVjC8o0hiVrwbSqER5luLVQfzAEdGdBiB4hR8A9D6dd9ldaE5YMTbtT_ZzlOphEKNiKF5hu1-ASRs" />
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row justify-between items-end mb-12">
              ...
              <div className="flex space-x-6 mt-6 md:mt-0">
                ...
                <Link className="font-label-caps text-label-caps text-primary uppercase tracking-widest hover:text-secondary transition-colors" to="/">Pinterest</Link>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="aspect-square bg-surface-container-low overflow-hidden group">
                <img alt="Aesthetic eyewear photography" className="w-full h-full object-cover transform group-hover:scale-105 transition-transform duration-700" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCXZSbBxgS0q_DXhvUREyJsWW_bZAw6WkcAWvLsxochijK770YMDmnX8HtNSjk_OnBDUO3x6UuzrDhEWSIFj_eDE2hvyMcHcTabj7Eh784OKFOZwqIJisGN64A1cG6zjaoSXvtE-FEFLwpZiMB4BCNNtwB_K4r2NJUzXeHiW8KMhGE3BHHVtqlZ6S_yZBKGzY_tHMFZGkEjwkM17wM7RSIBdmDGXBEveJXBSvROubWe2pEdIpnDSBH2ofZFVW1jVrXzXDHrUqiAe5Y" />
              </div>
              <div className="aspect-square bg-surface-container-low overflow-hidden group">
                <img alt="Aesthetic eyewear photography" className="w-full h-full object-cover transform group-hover:scale-105 transition-transform duration-700" src="https://lh3.googleusercontent.com/aida-public/AB6AXuD-azWAk3A9G9UGH6ZHTV-TImqXZjWsKyNkgKF_AJOr-BhXSFCN_ZXzUxFOuFzfH4hE9f5xM73B7uFf-7w2MhQBoZw2sp3B0cStOAsdIxMEm2Q3kxzNKsn8MTiD8lF0RHMPykVhRLcXDbOi-4FwgVtXOZ_FfdsdL4dkQ45XmQCfxvkjM1O31dzF6UeHeASzNVn7Y7RAVfbOPG-vUt1niavrVehaON1vWwAZEiaG21QNJeJaz0gKM5zthftaxGeDVbrhklw0-YNrti8" />
              </div>
              <div className="aspect-square bg-surface-container-low overflow-hidden group">
                <img alt="Aesthetic eyewear photography" className="w-full h-full object-cover transform group-hover:scale-105 transition-transform duration-700" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAmmOcfKjz4Ov2fvBMLE_gWqd_vWl9ZG5kcbyxuQSDf1BhD86RkKcn8e8fFFWx4dwYFm3f0NQmPYaNDetYFDc63JrWFXFcFtCKYqx6m0VHTZc6C-P60m_gC-p9jGAgK9gsxe8b1K8W0IjxfaCFkr6MCfvFP5LhnzYbLBBlL9aYAMVfEhm7MJVwmze6JQPjPTCwzqwEcLwCYBZosF5aGOFC2oT1n5xaRUIdusgOx6oHCukcRNwoJPgzJqyL0gRww9V9TcrrLeevFt_8" />
              </div>
              <div className="aspect-square bg-surface-container-low overflow-hidden group">
                <img alt="Aesthetic eyewear photography" className="w-full h-full object-cover transform group-hover:scale-105 transition-transform duration-700" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAKyhPaNcLvyLrgSzD0xnyN81ZugcU1ll_C_HgTVRscA882labig3NMnC5X3f7bq1GhvIRFLW4S7TAwPVLAkyWcGJihwOYpGVjuFOl8iiqdhtVS9jyKmKsPM7NnGQisYAuh8g4RjjCLFzl0jwwK2elMAx1bCPQ8x4IkLhQcprVghmw1hIVDboYt6sBRYqlC1HCyiV8yfUrEUt-wqgcY2k4etk00bZep3ltLctX1nvXcsGsXPfuvfrlzodQ8yQUGlXDTxVTc9pbVBw8" />
              </div>
            </div>
          </div>
        </section>
